...
func RunHttpServer(db *gorm.DB) {
	...
	dormitory_load_service := service.Newstructs.DormitoryLoadService(place_repository, room_repository, user_service)
	...
	dormitory_load_controller := handlers.Newstructs.DormitoryLoadController(dormitory_load_service)
	...
	mux.HandleFunc("/dormitory/load/stats", dormitory_load_controller.Getstructs.DormitoryLoadHandler)
